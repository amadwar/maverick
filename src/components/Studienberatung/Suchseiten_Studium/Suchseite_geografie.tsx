  ...
  return (
    <div className="such-seite">
      ...
      <div className="rectangle-19">
        ...
        Die Geographie bzw. Geografie (von altgriechisch γεωγραφία geōgraphía, deutsch ‚Erdbeschreibung‘;[1] abgeleitet von γῆ gē, deutsch ‚Erde‘ und γράφειν gráphein, deutsch ‚(auf-)schreiben‘) oder Erdkunde ist die sich mit der Erdoberfläche befassende Wissenschaft, sowohl in ihrer physischen Beschaffenheit wie auch als Raum und Ort des menschlichen Lebens und Handelns.Sie bewegt sich dabei an der Schnittstelle zwischen den Naturwissenschaften, Geistes- und Sozialwissenschaften.
        (Quelle Wikipedia)
        </span>
      </div>
...
export default Suchseite_geografie;
