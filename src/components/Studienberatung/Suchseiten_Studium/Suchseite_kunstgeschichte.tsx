...
function Suchseite_kunstgeschichte() {
  ...
  return (
    <div className="such-seite">
      ...
      <div className="rectangle-19">
        ...
        Das kunstgeschichtestudium ist das Studium der Fachrichtung kunstgeschichte. Es wird an Hochschulen mit einem akademischen Grad abgeschlossen. 
        (Quelle Wikipedia)
        </span>
      </div>
...
export default Suchseite_kunstgeschichte;
