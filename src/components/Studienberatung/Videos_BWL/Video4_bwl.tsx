    ...
    <div className="lernpfad-scrum">
      ...
      <div className="rectangle-1">  
       ...
       <StyledTreeItem nodeId="1" label={<Link className="link" to="/bwl">Betriebswirtschaftslehre</Link>}>
        <StyledTreeItem nodeId="2" label={checked ? <div className="checked"> <img className="heck" src={check} /><Link className="link" to="/video_bwl1">How The Economic Machine Works by Ray Dalio</Link></div> :<Link className="link" to="/video_bwl1">How The Economic Machine Works by Ray Dalio</Link>} />
        ...
        <div className="rectangle-6">
          <h3>How The Economic Machine Works by Ray Dalio</h3>
          
            <div className="video"><GetVideo link="https://entitygraph.azurewebsites.net/api/s/REAL_UI_MockUP_TdF/entities/PHe0bXAIuk0?property=sdo.identifier" width="600px" height="400px"/></div>
