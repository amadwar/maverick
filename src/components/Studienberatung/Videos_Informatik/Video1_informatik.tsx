    ...
    <div className="lernpfad-scrum">
      ...
      <div className="rectangle-1">  
       ...
       <StyledTreeItem nodeId="1" label={<Link className="link" to="/informatik">Informatik Studium</Link>}>
        <StyledTreeItem nodeId="2" label={checked ? <div className="checked"> <img className="heck" src={check} /><Link className="link" to="/video_informatik1">SO SO, DU willst also INFORMATIK STUDIEREN</Link></div> :<Link className="link" to="/video_informatik1">SO SO, DU willst also INFORMATIK STUDIEREN</Link>} />
        ...
        <div className="rectangle-6">
          <h3>SO SO, DU willst also INFORMATIK STUDIEREN</h3>
          
            <div className="video"><GetVideo link="https://entitygraph.azurewebsites.net/api/s/REAL_UI_MockUP_TdF/entities/c9k8BTd0Bbw?property=sdo.identifier" width="600px" height="400px"/></div>
...
export default Video_informatik1;