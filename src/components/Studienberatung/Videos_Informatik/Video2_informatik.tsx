    ...
    <div className="lernpfad-scrum">
      ...
      <div className="rectangle-1">  
       ...
       <StyledTreeItem nodeId="1" label={<Link className="link" to="/informatik">Informatik Studium</Link>}>
        ...
        <StyledTreeItem nodeId="3" label={checked ? <div className="checked"> <img className="heck" src={check} /><Link className="link" to="/video_informatik2">INFORMATIK studieren ohne Vorkenntnisse?!</Link></div> :<Link className="link" to="/video_informatik2">INFORMATIK studieren ohne Vorkenntnisse?!</Link>} />
        ...
        <div className="rectangle-6">
          <h3>INFORMATIK studieren ohne Vorkenntnisse?!</h3>
          
            <div className="video"><GetVideo link="https://entitygraph.azurewebsites.net/api/s/REAL_UI_MockUP_TdF/entities/S4ZfMMFKwk4?property=sdo.identifier" width="600px" height="400px"/></div>
...
export default Video_informatik2;