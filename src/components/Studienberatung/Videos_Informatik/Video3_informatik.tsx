    ...
    <div className="lernpfad-scrum">
      ...
      <div className="rectangle-1">  
       ...
       <StyledTreeItem nodeId="1" label={<Link className="link" to="/informatik">Informatik Studium</Link>}>
        ...
        <StyledTreeItem nodeId="4" label={checked ? <div className="checked"> <img className="heck" src={check} /><Link className="link" to="/video_informatik3">Duales Studium der Informatik!</Link></div> :<Link className="link" to="/video_informatik3">Duales Studium der Informatik!</Link>} />
        ...
        <div className="rectangle-6">
          <h3>Duales Studium der Informatik!</h3>
          
            <div className="video"><GetVideo link="https://entitygraph.azurewebsites.net/api/s/REAL_UI_MockUP_TdF/entities/F8HEgYGJPY4?property=sdo.identifier" width="600px" height="400px"/></div>
...
export default Video_informatik3;