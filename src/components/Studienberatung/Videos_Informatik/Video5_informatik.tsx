    ...
    <div className="lernpfad-scrum">
      ...
      <div className="rectangle-1">  
       ...
       <StyledTreeItem nodeId="1" label={<Link className="link" to="/informatik">Informatik Studium</Link>}>
        ...
        <StyledTreeItem nodeId="6" label={checked ? <div className="checked"> <img className="heck" src={check} /><Link className="link" to="/video_informatik5">Mathematical Informatics at the University of Tokyo</Link></div> :<Link className="link" to="/video_informatik5">Mathematical Informatics at the University of Tokyo</Link>} />
       </StyledTreeItem>
        ...
        <div className="rectangle-6">
          <h3>Mathematical Informatics at the University of Tokyo</h3>
          
            <div className="video"><GetVideo link="https://entitygraph.azurewebsites.net/api/s/REAL_UI_MockUP_TdF/entities/u3uS2wiDdE8?property=sdo.identifier" width="600px" height="400px"/></div>
...
export default Video_informatik5;