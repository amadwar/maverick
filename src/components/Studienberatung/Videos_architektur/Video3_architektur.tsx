    ...
    <div className="lernpfad-scrum">
      ...
      <div className="rectangle-1">  
       ...
       <StyledTreeItem nodeId="1" label={<Link className="link" to="/architektur">Architektur Studium</Link>}>
        ...
        <StyledTreeItem nodeId="4" label={checked ? <div className="checked"> <img className="heck" src={check} /><Link className="link" to="/video_architektur3">New ideas for a collaborative space on the Architecture Quad </Link></div> :<Link className="link" to="/video_architektur3">New ideas for a collaborative space on the Architecture Quad!</Link>} />
        ...
        <div className="rectangle-6">
          <h3><Gettitle link="https://entitygraph.azurewebsites.net/api/s/REAL_UI_MockUP_TdF/entities/q8uXSLfXw5g?property=sdo.identifier"/></h3>
          
            <div className="video"><GetVideo link="https://entitygraph.azurewebsites.net/api/s/REAL_UI_MockUP_TdF/entities/q8uXSLfXw5g?property=sdo.identifier" width="600px" height="400px"/></div>
...
export default Video_architektur3;