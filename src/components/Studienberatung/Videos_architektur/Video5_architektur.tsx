    ...
    <div className="lernpfad-scrum">
      ...
      <div className="rectangle-1">  
       ...
       <StyledTreeItem nodeId="1" label={<Link className="link" to="/architektur">Architektur Studium</Link>}>
        ...
        <StyledTreeItem nodeId="6" label={checked ? <div className="checked"> <img className="heck" src={check} /><Link className="link" to="/video_architektur5">Pro tip: Add a human subject in architecture to create scale! </Link></div> :<Link className="link" to="/video_architektur5">Pro tip: Add a human subject in architecture to create scale!</Link>} />
       </StyledTreeItem>
...
export default Video_architektur5;