...
function Video_elektrotechnik1(){
    ...
    <div className="lernpfad-scrum">
      ...
      <div className="rectangle-1">  
       ...
       <StyledTreeItem nodeId="1" label={<Link className="link" to="/elektrotechnik">Elektrotechnik Studium</Link>}>
        <StyledTreeItem nodeId="2" label={checked ? <div className="checked"> <img className="heck" src={check} /><Link className="link" to="/video_elektrotechnik1">Elektrischer Strom Erklärt </Link></div> :<Link className="link" to="/video_elektrotechnik1">Elektrischer Strom Erklärt</Link>} />
        ...
        <div className="rectangle-6">
          <h3><Gettitle link="https://entitygraph.azurewebsites.net/api/s/REAL_UI_MockUP_TdF/entities/Qu3j6Wr-lYE?property=sdo.identifier"/></h3>
          
            <div className="video"><GetVideo link="https://entitygraph.azurewebsites.net/api/s/REAL_UI_MockUP_TdF/entities/Qu3j6Wr-lYE?property=sdo.identifier" width="600px" height="400px"/></div>
...
export default Video_elektrotechnik1;