...
function Video_elektrotechnik4(){
    ...
    <div className="lernpfad-scrum">
      ...
      <div className="rectangle-1">  
       ...
       <StyledTreeItem nodeId="1" label={<Link className="link" to="/elektrotechnik">Elektrotechnik Studium</Link>}>
        ...
        <StyledTreeItem nodeId="5" label={checked ? <div className="checked"> <img className="heck" src={check} /><Link className="link" to="/video_elektrotechnik4">Elektrotechnik Grundlagen 1 </Link></div> :<Link className="link" to="/video_elektrotechnik4">Elektrotechnik Grundlagen 1</Link>} />
        ...
        <div className="rectangle-6">
          <h3><Gettitle link="https://entitygraph.azurewebsites.net/api/s/REAL_UI_MockUP_TdF/entities/0tFovkCI0lE?property=sdo.identifier"/></h3>
          
            <div className="video"><GetVideo link="https://entitygraph.azurewebsites.net/api/s/REAL_UI_MockUP_TdF/entities/0tFovkCI0lE?property=sdo.identifier" width="600px" height="400px"/></div>
...
export default Video_elektrotechnik4;