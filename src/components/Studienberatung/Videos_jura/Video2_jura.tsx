    ...
    <div className="lernpfad-scrum">
      ...
      <div className="rectangle-1">  
       ...
       <StyledTreeItem nodeId="1" label={<Link className="link" to="/jura">Jura Studium</Link>}>
        ...
        <StyledTreeItem nodeId="3" label={checked ? <div className="checked"> <img className="heck" src={check} /><Link className="link" to="/video_jura2">ច្បាប់រដ្ឋប្បវេណី និងច្បាប់ព្រហ្មទណ្ឌ civil law and crimenal law </Link></div> :<Link className="link" to="/video_jura2">ច្បាប់រដ្ឋប្បវេណី និងច្បាប់ព្រហ្មទណ្ឌ civil law and crimenal law</Link>} />
        ...
        <div className="rectangle-6">
          <h3><Gettitle link="https://entitygraph.azurewebsites.net/api/s/REAL_UI_MockUP_TdF/entities/h3d7UumzblQ?property=sdo.identifier"/></h3>
          
            <div className="video"><GetVideo link="https://entitygraph.azurewebsites.net/api/s/REAL_UI_MockUP_TdF/entities/h3d7UumzblQ?property=sdo.identifier" width="600px" height="400px"/></div>
