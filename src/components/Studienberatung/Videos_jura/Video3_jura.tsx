            ...
            <div className="rectangle-1">  
              ...
              >
                <StyledTreeItem nodeId="1" label={<Link className="link" to="/jura">{data?.[1]?.["https://schema.org/termCode"]?.map(title => title["@value"]).join(', ')}</Link>}>
                  ...
                  <StyledTreeItem nodeId="4" label={checked ? <div className="checked"> <img className="heck" src={check} /><Link className="link" to="/video_jura3">{data?.[3]?.["https://schema.org/title"]?.map(title => title["@value"]).join(', ')}</Link></div> :<Link className="link" to="/video_jura3">{data?.[3]?.["https://schema.org/title"]?.map(title => title["@value"]).join(', ')}</Link>} />
