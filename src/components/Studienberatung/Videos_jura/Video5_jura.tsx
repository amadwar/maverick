    ...
    <div className="lernpfad-scrum">
      ...
      <div className="rectangle-1">  
       ...
       <StyledTreeItem nodeId="1" label={<Link className="link" to="/jura">Jura Studium</Link>}>
        ...
        <StyledTreeItem nodeId="6" label={checked ? <div className="checked"> <img className="heck" src={check} /><Link className="link" to="/video_jura5">Constitutional Law: Standards of Review (Rational Basis, Intermediate Scrutiny, & Strict Scrutiny) </Link></div> :<Link className="link" to="/video_jura5">Constitutional Law: Standards of Review (Rational Basis, Intermediate Scrutiny, & Strict Scrutiny)</Link>} />
       </StyledTreeItem>
        ...
        <div className="rectangle-6">
          <h3><Gettitle link="https://entitygraph.azurewebsites.net/api/s/REAL_UI_MockUP_TdF/entities/tVMbLtP7VSk?property=sdo.identifier"/></h3>
          
            <div className="video"><GetVideo link="https://entitygraph.azurewebsites.net/api/s/REAL_UI_MockUP_TdF/entities/tVMbLtP7VSk?property=sdo.identifier" width="600px" height="400px"/></div>
