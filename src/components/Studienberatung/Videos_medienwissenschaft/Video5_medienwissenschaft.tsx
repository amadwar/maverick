...
function Video_medienwissenschaft5(){
  ...
  const handleMinusClick = () => {
            ...
            <div className="rectangle-1">  
              ...
              >
                <StyledTreeItem nodeId="1" label={<Link className="link" to="/medienwissenschaft">{data?.[1]?.["https://schema.org/termCode"]?.map(title => title["@value"]).join(', ')}</Link>}>
                 ...
                 <StyledTreeItem nodeId="6" label={checked ? <div className="checked"> <img className="heck" src={check} /><Link className="link" to="/video_medienwissenschaft5">{data?.[5]?.["https://schema.org/title"]?.map(title => title["@value"]).join(', ')}</Link></div> :<Link className="link" to="/video_medienwissenschaft5">{data?.[5]?.["https://schema.org/title"]?.map(title => title["@value"]).join(', ')}</Link>} />
                </StyledTreeItem>   
              </TreeView>
    ...
    export default Video_medienwissenschaft5;
