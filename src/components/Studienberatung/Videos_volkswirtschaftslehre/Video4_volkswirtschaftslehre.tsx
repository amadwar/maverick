...
function Video_volkswirtschaftslehre4(){
  ...
  const handleMinusClick = () => {
            ...
            <div className="rectangle-1">  
              ...
              >
                <StyledTreeItem nodeId="1" label={<Link className="link" to="/volkswirtschaftslehre">{data?.[1]?.["https://schema.org/termCode"]?.map(title => title["@value"]).join(', ')}</Link>}>
                  ...
                  <StyledTreeItem nodeId="5" label={checked ? <div className="checked"> <img className="heck" src={check} /><Link className="link" to="/video_volkswirtschaftslehre4">{data?.[4]?.["https://schema.org/title"]?.map(title => title["@value"]).join(', ')}</Link></div> :<Link className="link" to="/video_volkswirtschaftslehre4">{data?.[4]?.["https://schema.org/title"]?.map(title => title["@value"]).join(', ')}</Link>} />
    ...
    export default Video_volkswirtschaftslehre4;
