...
function Definitioneninderinformatik(){
            ...
            <>
              ...
              sx={{ height: 264, flexGrow: 1, maxWidth: 400, overflowY: 'auto' }}>
                ...
                <StyledTreeItem nodeId="1" label={<Link className="link" to="/Grundgebietederinformatik">Grundgebiete der Informatik</Link>}>
                    ...
                    <StyledTreeItem nodeId="3" label={<Link className="link" to="/c-programmierung">C-Programmierung</Link>}>
                    ...
                    <StyledTreeItem nodeId="4" label={<Link className="link" to="/laufzeitanalyse">Laufzeitanalyse</Link>}>
...
export default Definitioneninderinformatik;