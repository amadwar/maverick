...
function O_Notationundrechenregeln(){
    ...
    return (
        <div className="lernpfad-scrum">
          {data.length ? (  // überprüft, ob Daten vorhanden sind
            <>
              <span className="scrum">{data[32]["https://schema.org/termCode"]?.map(title => title["@value"]).join(', ')}</span>
          ...
          <div className="videos">
            <div><Link className="link" to="/video_o-Notationundrechenregeln1"><img className="img" src={data[31]["https://schema.org/thumbnailUrl"]?.map(thumbnail => thumbnail["@value"]).join(', ')} alt="Thumbnail" /></Link><h6 style={{whiteSpace: "pre-line"}}>{data[31]["https://schema.org/title"]?.map(title => title["@value"]).join(', ')}</h6> </div>
            <div><Link className="link" to="/video_o-Notationundrechenregeln2"><img className="img" src={data[33]["https://schema.org/thumbnailUrl"]?.map(thumbnail => thumbnail["@value"]).join(', ')} alt="Thumbnail" /></Link><h6 style={{whiteSpace: "pre-line"}}>{data[33]["https://schema.org/title"]?.map(title => title["@value"]).join(', ')}</h6>  </div>
            <div><Link className="link" to="/video_o-Notationundrechenregeln3"><img className="img" src={data[34]["https://schema.org/thumbnailUrl"]?.map(thumbnail => thumbnail["@value"]).join(', ')} alt="Thumbnail" /></Link><h6 style={{whiteSpace: "pre-line"}}>{data[34]["https://schema.org/title"]?.map(title => title["@value"]).join(', ')}</h6>  </div>
            <div><Link className="link" to="/video_o-Notationundrechenregeln4"><img className="img" src={data[35]["https://schema.org/thumbnailUrl"]?.map(thumbnail => thumbnail["@value"]).join(', ')} alt="Thumbnail" /></Link><h6 style={{whiteSpace: "pre-line"}}>{data[35]["https://schema.org/title"]?.map(title => title["@value"]).join(', ')}</h6>  </div>
            <div><Link className="link" to="/video_o-Notationundrechenregeln5"><img className="img" src={data[36]["https://schema.org/thumbnailUrl"]?.map(thumbnail => thumbnail["@value"]).join(', ')} alt="Thumbnail" /></Link><h6 style={{whiteSpace: "pre-line"}}>{data[36]["https://schema.org/title"]?.map(title => title["@value"]).join(', ')}</h6>  </div>
          </div>
...
export default O_Notationundrechenregeln;