...
function Video_kontrollanweisungenn1(){
  ...
  const handleMinusClick = () => {
            ...
            <div className="rectangle-1">  
              ...
              >
                <StyledTreeItem nodeId="1" label={<Link className="link" to="/kontrollanweisungenn">{data?.[1]?.["https://schema.org/termCode"]?.map(title => title["@value"]).join(', ')}</Link>}>
                  <StyledTreeItem nodeId="2" label={checked ? <div className="checked"> <img className="heck" src={check} /><Link className="link" to="/video_kontrollanweisungenn1">{data?.[0]?.["https://schema.org/title"]?.map(title => title["@value"]).join(', ')}</Link></div> :<Link className="link" to="/video_kontrollanweisungenn1"> {data?.[0]?.["https://schema.org/title"]?.map(title => title["@value"]).join(', ')} </Link>} />
    ...
    export default Video_kontrollanweisungenn1;
