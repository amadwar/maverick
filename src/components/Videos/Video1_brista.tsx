    ...
    <div className="lernpfad-scrum">
      ...
      <div className="rectangle-1">  
       ...
       <StyledTreeItem nodeId="1" label={<Link className="link" to="/brista">Barista</Link>}>
        <StyledTreeItem nodeId="2" label={checked ? <div className="checked"> <img className="heck" src={check} /><Link className="link" to="/Video_brista1">How to use Hario V60</Link></div> : <Link className="link" to="/video_brista1">How to use Hario V60</Link>} />
        ...
        <div className="rectangle-6">
          <h3>How to use Hario V60</h3>
          
            <div className="video"><GetVideo link="https://entitygraph.azurewebsites.net/api/s/REAL_UI_MockUP_TdF/entities/ZC8gEzKml6Q?property=sdo.identifier" width="600px" height="400px"/></div>
