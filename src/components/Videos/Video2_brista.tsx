    ...
    <div className="lernpfad-scrum">
      ...
      <div className="rectangle-1">  
       ...
       <StyledTreeItem nodeId="1" label={<Link className="link" to="/brista">Barista</Link>}>
        ...
        <StyledTreeItem nodeId="3" label={checked ? <div className="checked"> <img className="heck" src={check} /><Link className="link" to="/Video_brista2">Unboxing & set up of Nescafe Gold Barista</Link></div> :<Link className="link" to="/Video_brista2">Unboxing & set up of Nescafe Gold Barista</Link>} />
        ...
        <div className="rectangle-6">
          <h3>Unboxing & set up of Nescafe Gold Barista</h3>
          
            <div className="video"><GetVideo link="https://entitygraph.azurewebsites.net/api/s/REAL_UI_MockUP_TdF/entities/0AE6iT3l13I?property=sdo.identifier" width="600px" height="400px"/></div>
