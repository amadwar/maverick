...
function Video_devops2(){
  ...
  return (
    <div className="lernpfad-scrum">
      ...
      <StyledTreeItem nodeId="3" label={checked ? <div className="checked"> <img className="heck" src={check} /><Link className="link" to="/video_devops2">Terraform and Azure DevOps</Link></div> : <Link className="link" to="/video_devops2">Terraform and Azure DevOps</Link>} />
      ...
      <StyledTreeItem nodeId="5" label={<Link className="link" to="/video_devops4">Retrospectives: Be Agile and Thrive</Link>} />
        ...
        <div className="rectangle-6">
          <h3>Terraform and Azure DevOps</h3>
          
            <div className="video"><GetVideo link="https://entitygraph.azurewebsites.net/api/s/REAL_UI_MockUP_TdF/entities/Llx4TeU2Hms?property=sdo.identifier" width="600px" height="400px"/></div>
