...
function Video_garten2(){
  ...
  return (
    <div className="lernpfad-scrum">
      ...
      <StyledTreeItem nodeId="1" label={<Link className="link" to="/gaertner">Gärtner</Link>}>
        <StyledTreeItem nodeId="2" label={<Link className="link" to="/video_garten1">Stop Watering Your Garden!</Link>} />
        <StyledTreeItem nodeId="3" label={checked ? <div className="checked"> <img className="heck" src={check} /><Link className="link" to="/video_garten2">Chisel Plow and Cultivator from Vegetable Farmers</Link></div> :<Link className="link" to="/video_garten2">Chisel Plow and Cultivator from Vegetable Farmers</Link>} />
        ...
        <div className="rectangle-6">
          <h3>Chisel Plow and Cultivator from Vegetable Farmers</h3>
          
            <div className="video"><GetVideo link="https://entitygraph.azurewebsites.net/api/s/REAL_UI_MockUP_TdF/entities/eOrzuu5I_gc?property=sdo.identifier" width="600px" height="400px"/></div>
