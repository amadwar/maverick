  ...
  return (
    <div className="lernpfad-scrum">
      ...
      <StyledTreeItem nodeId="1" label={<Link className="link" to="/malen">Malen</Link>}>
        ...
        <StyledTreeItem nodeId="3" label={checked ? <div className="checked"> <img className="heck" src={check} /><Link className="link" to="/video_malen2">Alcohol Ink WISPY Looks + embellishments </Link></div> :<Link className="link" to="/video_malen2">Alcohol Ink WISPY Looks + embellishments</Link>} />
        ...
        <div className="rectangle-6">
          <h3>Alcohol Ink WISPY Looks + embellishments</h3>
          
            <div className="video"><GetVideo link="https://entitygraph.azurewebsites.net/api/s/REAL_UI_MockUP_TdF/entities/70wtDY5WwnE?property=sdo.identifier" width="600px" height="400px"/></div>
