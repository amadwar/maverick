      ...
      <div className="rectangle-1">  
       ...
       <StyledTreeItem nodeId="1" label={<Link className="link" to="/scrum">Scrum</Link>}>
        ...
        <div className="rectangle-6">
          <h3>Introduction to Scrum - 7 Minutes</h3>
          
            <div className="video"><GetVideo link="https://entitygraph.azurewebsites.net/api/s/REAL_UI_MockUP_TdF/entities/9TycLR0TqFA?property=sdo.identifier" width="600px" height="400px"/></div>
