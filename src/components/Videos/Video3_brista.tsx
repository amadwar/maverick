    ...
    <div className="lernpfad-scrum">
      ...
      <div className="rectangle-1">  
       ...
       <StyledTreeItem nodeId="1" label={<Link className="link" to="/brista">Barista</Link>}>
        ...
        <StyledTreeItem nodeId="4" label={checked ? <div className="checked"> <img className="heck" src={check} /><Link className="link" to="/Video_brista3">iDrinkCoffee.com Review</Link></div> :<Link className="link" to="/video_brista3">iDrinkCoffee.com Review</Link>} />
        ...
        <div className="rectangle-6">
          <h3>iDrinkCoffee.com Review</h3>
          
            <div className="video"><GetVideo link="https://entitygraph.azurewebsites.net/api/s/REAL_UI_MockUP_TdF/entities/nfqVdAigLJI?property=sdo.identifier" width="600px" height="400px"/></div>
