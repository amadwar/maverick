  ...
  return (
    <div className="lernpfad-scrum">
      ...
      <StyledTreeItem nodeId="1" label={<Link className="link" to="/gaertner">Gärtner</Link>}>
        ...
        <StyledTreeItem nodeId="4" label={checked ? <div className="checked"> <img className="heck" src={check} /><Link className="link" to="/video_garten3">Bountiful Harvest in the Organic Vegetable Garden</Link></div> :<Link className="link" to="/video_garten3">Bountiful Harvest in the Organic Vegetable Garden</Link>} />
        ...
        <div className="rectangle-6">
          <h3>Bountiful Harvest in the Organic Vegetable Garden</h3>
          
            <div className="video"><GetVideo link="https://entitygraph.azurewebsites.net/api/s/REAL_UI_MockUP_TdF/entities/19UL645J-5Y?property=sdo.identifier" width="600px" height="400px"/></div>
