    ...
    <div className="lernpfad-scrum">
      ...
      <div className="rectangle-1">  
       ...
       <StyledTreeItem nodeId="1" label="Scrum">
        ...
        <StyledTreeItem nodeId="4" label={checked ? <div className="checked"> <img className="heck" src={check} /><Link className="link" to="/Video_Scrum3">3 Key Points for Scrum Masters in the new Scrum Guide 2022</Link></div> :<Link className="link" to="Video_Scrum3">3 Key Points for Scrum Masters in the new Scrum Guide 2022</Link>} />
        ...
        <div className="rectangle-6">
          <h3>3 Key Points for Scrum Masters in the new Scrum Guide 2022</h3>
          
            <div className="video"><GetVideo link="https://entitygraph.azurewebsites.net/api/s/REAL_UI_MockUP_TdF/entities/tM5eqyv5JxI?property=sdo.identifier" width="600px" height="400px"/></div>
