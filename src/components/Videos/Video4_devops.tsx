...
function Video_devops4(){
  ...
  return (
    <div className="lernpfad-scrum">
      ...
      <StyledTreeItem nodeId="5" label={checked ? <div className="checked"> <img className="heck" src={check} /><Link className="link" to="/video_devops4">Retrospectives: Be Agile and Thrive</Link></div> : <Link className="link" to="/video_devops4">Retrospectives: Be Agile and Thrive</Link>} />
       </StyledTreeItem>
       </TreeView>
        ...
        <div className="rectangle-6">
          <h3>Retrospectives: Be Agile and Thrive</h3>
          
            <div className="video"><GetVideo link="https://entitygraph.azurewebsites.net/api/s/REAL_UI_MockUP_TdF/entities/CqTVIOzBRno?property=sdo.identifier" width="600px" height="400px"/></div>
