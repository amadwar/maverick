  ...
  return (
    <div className="lernpfad-scrum">
     ...
     <StyledTreeItem nodeId="1" label={<Link className="link" to="/gaertner">Gärtner</Link>}>
        ...
        <StyledTreeItem nodeId="5" label={checked ? <div className="checked"> <img className="heck" src={check} /><Link className="link" to="/video_garten4">Manage Weeds on Your Farm: Blind Cultivation at the Martens Farm</Link></div> :<Link className="link" to="/video_garten4">Manage Weeds on Your Farm: Blind Cultivation at the Martens Farm</Link>} />
        ...
        <div className="rectangle-6">
          <h3>Manage Weeds on Your Farm: Blind Cultivation at the Martens Farm</h3>
          
            <div className="video"><GetVideo link="https://entitygraph.azurewebsites.net/api/s/REAL_UI_MockUP_TdF/entities/jOmcCm7l0MU?property=sdo.identifier" width="600px" height="400px"/></div>
