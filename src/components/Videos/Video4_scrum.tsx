    ...
    <div className="lernpfad-scrum">
      ...
      <div className="rectangle-1">  
       ...
       <StyledTreeItem nodeId="1" label={<Link className="link" to="/scrum">Scrum</Link>}>
        ...
        <StyledTreeItem nodeId="5" label={checked ? <div className="checked"> <img className="heck" src={check} /><Link className="link" to="/Video_Scrum4">Bad Low Profile Coolers Beware: Scythe Is Coming!</Link></div> :<Link className="link" to="Video_Scrum4">Bad Low Profile Coolers Beware: Scythe Is Coming!</Link>} />
        ...
        <div className="rectangle-6">
          <h3>Bad Low Profile Coolers Beware: Scythe Is Coming!</h3>
          
            <div className="video"><GetVideo link="https://entitygraph.azurewebsites.net/api/s/REAL_UI_MockUP_TdF/entities/1awBzsA78VQ?property=sdo.identifier" width="600px" height="400px"/></div>
