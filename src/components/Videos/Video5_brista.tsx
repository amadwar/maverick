  ...
  return (
    <div className="lernpfad-scrum">
      ...
      <div className="rectangle-1">  
       ...
       <StyledTreeItem nodeId="1" label={<Link className="link" to="/brista">Barista</Link>}>
        ...
        <StyledTreeItem nodeId="6" label={checked ? <div className="checked"> <img className="heck" src={check} /><Link className="link" to="/Video_brista5">The Complete Beginner's Guide to Buying Chef Knives</Link></div> :<Link className="link" to="/video_brista5">The Complete Beginner's Guide to Buying Chef Knives</Link>} />
       </StyledTreeItem>
        ...
        <div className="rectangle-6">
          <h3>The Complete Beginner's Guide to Buying Chef Knives</h3>
          
            <div className="video"><GetVideo link="https://entitygraph.azurewebsites.net/api/s/REAL_UI_MockUP_TdF/entities/YeXlocfenf8?property=sdo.identifier" width="600px" height="400px"/></div>
