  ...
  return (
    <div className="lernpfad-scrum">
      ...
      <StyledTreeItem nodeId="1" label={<Link className="link" to="/gaertner">Gärtner</Link>}>
        ...
        <StyledTreeItem nodeId="5" label={checked ? <div className="checked"> <img className="heck" src={check} /><Link className="link" to="/video_garten5">WEED FREE MARKET GARDENING</Link></div> :<Link className="link" to="/video_garten5">WEED FREE MARKET GARDENING</Link>} />
      </StyledTreeItem>
        ...
        <div className="rectangle-6">
          <h3>WEED FREE MARKET GARDENING</h3>
          
            <div className="video"><GetVideo link="https://entitygraph.azurewebsites.net/api/s/REAL_UI_MockUP_TdF/entities/u79tiVcj8bY?property=sdo.identifier" width="600px" height="400px"/></div>
