...
<StyledTreeItem nodeId="1" label="Scrum">
        ...
        <StyledTreeItem nodeId="6" label={checked ? <div className="checked"> <img className="heck" src={check} /><Link className="link" to="/Video_Scrum5">COSM - STOCHASTIC PROCESSES - INTRODUCTION</Link></div> :<Link className="link" to="Video_Scrum5">COSM - STOCHASTIC PROCESSES - INTRODUCTION</Link>} />
       </StyledTreeItem>
        ...
        <div className="rectangle-6">
          <h3>COSM - STOCHASTIC PROCESSES - INTRODUCTION</h3>
          
            <div className="video"><GetVideo link="https://entitygraph.azurewebsites.net/api/s/REAL_UI_MockUP_TdF/entities/Llf78-XbLTo?property=sdo.identifier" width="600px" height="400px"/></div>
