    ...
    <div className="lernpfad-scrum">
      ...
      <div className="rectangle-1">  
       ...
       <StyledTreeItem nodeId="1" label={<Link className="link" to="/teamleitung">Teamleitung</Link>}>
        <StyledTreeItem nodeId="2" label={checked ? <div className="checked"> <img className="heck" src={check} /><Link className="link" to="/video_teamleitung1">Phasen der Teamentwicklung nach Tuckman: Alles Wichtige zur Teamuhr</Link></div> :<Link className="link" to="/video_teamleitung1">Phasen der Teamentwicklung nach Tuckman: Alles Wichtige zur Teamuhr</Link>} />
        ...
        <div className="rectangle-6">
          <h3>Phasen der Teamentwicklung nach Tuckman: Alles Wichtige zur Teamuhr</h3>
          
            <div className="video"><GetVideo link="https://entitygraph.azurewebsites.net/api/s/REAL_UI_MockUP_TdF/entities/TW_B1skghSY?property=sdo.identifier" width="600px" height="400px"/></div>
...
export default Video_teamleitung1;