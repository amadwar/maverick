  ...
  return (
    <div className="lernpfad-scrum">
      ...
      <div className="rectangle-1">  
       ...
       <StyledTreeItem nodeId="1" label={<Link className="link" to="/teamleitung">Teamleitung</Link>}>
        ...
        <StyledTreeItem nodeId="3" label={checked ? <div className="checked"> <img className="heck" src={check} /><Link className="link" to="/video_teamleitung2">Video Review for the The Five Dysfunctions of a Team: A Leadership Fable by Patrick Lencioni</Link></div> :<Link className="link" to="/video_teamleitung2">Video Review for the The Five Dysfunctions of a Team: A Leadership Fable by Patrick Lencioni</Link>} />
        ...
        <div className="rectangle-6">
          <h3>Video Review for the The Five Dysfunctions of a Team: A Leadership Fable by Patrick Lencioni</h3>
          
            <div className="video"><GetVideo link="https://entitygraph.azurewebsites.net/api/s/REAL_UI_MockUP_TdF/entities/509V7Z9OUQA?property=sdo.identifier" width="600px" height="400px"/></div>
...
export default Video_teamleitung2;