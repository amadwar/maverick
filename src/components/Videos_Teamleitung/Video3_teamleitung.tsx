    ...
    <div className="lernpfad-scrum">
      ...
      <div className="rectangle-1">  
       ...
       <StyledTreeItem nodeId="1" label={<Link className="link" to="/teamleitung">Teamleitung</Link>}>
        ...
        <StyledTreeItem nodeId="4" label={checked ? <div className="checked"> <img className="heck" src={check} /><Link className="link" to="/video_teamleitung3">Getting started with groups and teams provisioning</Link></div> :<Link className="link" to="/video_teamleitung3">Getting started with groups and teams provisioning</Link>} />
        ...
        <div className="rectangle-6">
          <h3>Getting started with groups and teams provisioning</h3>
          
            <div className="video"><GetVideo link="https://entitygraph.azurewebsites.net/api/s/REAL_UI_MockUP_TdF/entities/G10q8lLQI0Q?property=sdo.identifier" width="600px" height="400px"/></div>
...
export default Video_teamleitung3;