    ...
    <div className="lernpfad-scrum">
      ...
      <div className="rectangle-1">  
       ...
       <StyledTreeItem nodeId="1" label={<Link className="link" to="/teamleitung">Teamleitung</Link>}>
        ...
        <StyledTreeItem nodeId="5" label={checked ? <div className="checked"> <img className="heck" src={check} /><Link className="link" to="/video_teamleitung4">Self Organization and the role of a Scrum Master</Link></div> :<Link className="link" to="/video_teamleitung4">Self Organization and the role of a Scrum Master</Link>} />
        ...
        <div className="rectangle-6">
          <h3>Self Organization and the role of a Scrum Master</h3>
          
            <div className="video"><GetVideo link="https://entitygraph.azurewebsites.net/api/s/REAL_UI_MockUP_TdF/entities/JSuFSduvBrs?property=sdo.identifier" width="600px" height="400px"/></div>
...
export default Video_teamleitung4;