    ...
    <div className="lernpfad-scrum">
      ...
      <div className="rectangle-1">  
       ...
       <StyledTreeItem nodeId="1" label={<Link className="link" to="/teamleitung">Teamleitung</Link>}>
        ...
        <StyledTreeItem nodeId="6" label={checked ? <div className="checked"> <img className="heck" src={check} /><Link className="link" to="/video_teamleitung5">5 Things to Cover in Weekly Team Meetings</Link></div> :<Link className="link" to="/video_teamleitung5">5 Things to Cover in Weekly Team Meetings</Link>} />
       </StyledTreeItem>
        ...
        <div className="rectangle-6">
          <h3>5 Things to Cover in Weekly Team Meetings</h3>
          
            <div className="video"><GetVideo link="https://entitygraph.azurewebsites.net/api/s/REAL_UI_MockUP_TdF/entities/f3Fl2M-eCZc?property=sdo.identifier" width="600px" height="400px"/></div>
...
export default Video_teamleitung5;